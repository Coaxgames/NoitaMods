init_debugger = function()
    ...
    function debug_wand(wand_deck, wand_stats)
        ...
        local original_ComponentGetValue                        = ComponentGetValue
        local original_ComponentSetValue                        = ComponentSetValue
        local original_ComponentGetIsEnabled                    = ComponentGetIsEnabled
        local original_EntityGetAllChildren                     = EntityGetAllChildren
        local original_EntityAddChild                           = EntityAddChild
        local original_EntitySetComponentsWithTagEnabled        = EntitySetComponentsWithTagEnabled
        local original_GetGameEffectLoadTo                      = GetGameEffectLoadTo
        ...
        ComponentGetValue2                       = function(component_id, variable_name) if(component_id) then return component_id[variable_name] end end
        ComponentSetValue2                       = function(component_id, variable_name, value) if(component_id) then component_id[variable_name] = value end end

        ComponentGetValue                        = function(component_id, variable_name) end
        ComponentSetValue                        = function(component_id, variable_name, value) end
        ComponentGetIsEnabled                    = function(component_id) end
        EntityAddChild                           = function(entity_id, child_id) end
        EntitySetComponentsWithTagEnabled        = function(entity_id, tag, enabled) end
        GetGameEffectLoadTo                      = function(entity_id, game_effect_name, always_load_new) end
        ...
        ComponentGetValue                        = original_ComponentGetValue
        ComponentSetValue                        = original_ComponentSetValue
        ComponentGetIsEnabled                    = original_ComponentGetIsEnabled
        EntityGetAllChildren                     = original_EntityGetAllChildren
        EntityAddChild                           = original_EntityAddChild
        EntitySetComponentsWithTagEnabled        = original_EntitySetComponentsWithTagEnabled
        GetGameEffectLoadTo                      = original_GetGameEffectLoadTo
